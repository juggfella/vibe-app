    ...
    },
    {
        ...
        services: [
            ...
            },
            {
                id: 204,
                name: "Груша",
                description: "Вкус натуральной сладкой груши с легким фруктовым послевкусием.",
                username: "user204",
            ...
            },
            {
                id: 205,
                name: "Дынный чизкейк",
                description: "Легкий вкусный тортик, украшенный сверху дынными дольками – беспрецедентный фруктово-десертный тандем.",
                username: "user205",
            ...
            },
            {
                ...
                description: "Не такая, как все... ЯРКИЙ кислый вкус маркуйи с насыщенным натуральным тропическим вкусом.",
                username: "user208",
            ...
            },
            {
                ...
                description: "Газированный напиток с клубничным сиропом и цитрусовыми нотами на послевкусии",
                username: "user209",
            ...
            },
            {
                ...
                description: "Холодный итальянский десерт, напоминающий сорбет, из свежих ягод малины.",
                username: "user215",
        ...
        services: [
            {
                ...
                description: "Сладкий и освежающий микс, который сочетает в себе сочность арбуза, тропическую сладость манго и нежность молочного коктейля. Идеально для жаркого дня.",
            ...
            },
            {
                ...
                description: "Ароматный персиковый чай с нотками сладкой дыни и меда. Этот микс подарит вам ощущение летнего утра в саду.",
                username: "user303",
            ...
            },
            {
                ...
                description: "Освежающий коктейль с ароматом груши, лайма и нотками кактуса. Идеально для тех, кто любит яркие и освежающие вкусы.",
                username: "user305",
            ...
            },
            {
                ...
                description: "Тропический манго в сочетании с освежающим зеленым виноградом. Этот микс подарит вам ощущение солнечного дня на пляже.",
                username: "user307",
            ...
            },
            {
                ...
                description: "Нежное кокосовое молоко с кислинкой малины и сливками. Этот микс создаст атмосферу тропического рая.",
                username: "user309",
            ...
            },
            {
                ...
                description: "Классическая кола с цитрусовыми нотками апельсина и восточными пряностями кашмира. Этот микс добавит в ваш вечер нотки экзотики.",
                username: "user311",
            ...
            },
            {
                ...
                description: "Сладкое яблоко с освежающим тархуном и нотками фейхоа. Этот микс подарит вам ощущение свежести и легкости.",
                username: "user313",
            ...
            },
            {
                ...
                description: "Освежающая газировка с цитрусовыми нотками и сладостью ананаса. Этот микс идеально подойдет для тех, кто любит яркие и бодрящие вкусы.",
                username: "user314",
